...
import { StandardMaterialMatrixTexture } from "../standard/standard-material-matrix-texture"
import { Debug } from "../../debug"
import { Message } from "../../message"
import { CubemapFormat } from "../../cubemap/cubemap-format"

export namespace StandardSurfaceMaterialFeatureSet {
  // export function build(renderer: Renderer, mesh: Mesh3D, material: StandardSurfaceMaterial, lightingEnvironment: LightingEnvironment) {
  //   let features: string[] = []
  ...
  export function getVertexFeatures(renderer: Renderer, mesh: Mesh3D, material: StandardSurfaceMaterial) {
    let features: string[] = []
  ...
  export function getFragmentFeatures(renderer: Renderer, mesh: Mesh3D, material: StandardSurfaceMaterial, lightingEnvironment: LightingEnvironment) {
    let features: string[] = []
